...
export default function ErrorPage({
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[70vh] px-4 text-center">
      ...
      <h1 className="text-3xl font-black mb-3 text-rose-400">Something Went Wrong</h1>
      <p className="text-slate-400 max-w-md mb-8 text-sm">
        An unexpected server-side process exception occurred while evaluating your influencer products.
      </p>
      <div className="flex gap-4">
        ...
        <a
          href="/"
          className="px-6 py-3 bg-white/10 text-white border border-white/10 rounded-xl font-bold hover:bg-white/20 transition-all text-sm"
        >
          Go Home
        </a>
      </div>
